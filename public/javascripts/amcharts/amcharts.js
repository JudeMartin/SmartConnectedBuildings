    ...
    if (l) {
        ...
        if (n.width > h) {
            ...
            if (isNaN(q)) {
                ...
                for (p = 1; p < h; p++)q = Math.round(b.length / h * p), b = b.substr(0, q) + m + b.substr(q);
    ...
    inherits: AmCharts.AxisBase, construct: function (a) {
        ...
        if (this.logarithmic && (0 >= this.getMin(0, this.data.length -
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)g = !0; else {
                ...
                w = !1;
                for (d = p; d < r; d += n)A = AmCharts.roundTo(this.step * d + this.min, q), -1 != String(A).indexOf("e") && (w = !0, String(A).split("e"));
                ...
                for (d = p; d < r; d += n)if (p =
                        q * d + this.min, p = AmCharts.roundTo(p, this.maxDecCount + 1), !this.integersOnly || Math.round(p) == p)if (isNaN(t) || Number(AmCharts.toFixed(p, t)) == p) {
                    ...
                    if (!isNaN(I) && 0 < A && d < r - 1) {
                        ...
                        for (c = 1; c < q / I; c++)C = this.getCoordinate(p + I * c), C = new this.axisItemRenderer(this, C, "", !1, 0, 0, !1, !1, 0, !0), this.pushAxisItem(C);
                        this.gridAlpha = s
                    }
                }
                d = this.baseValue;
        ...
        for (k = this.start; k <= this.end; k++)for (n = 0; n < h.length; n++)m = h[n], m.hidden || (l = m.type, m.chart == this.chart && m.valueAxis == this && a ==
        ...
        if (this.includeGuidesInMinMax && 0 < a)for (b = 0; b < a; b++)c = this.guides[b], c.toValue <
            ...
            for (f in e)if (e.hasOwnProperty(f)) {
                ...
                if (g.includeInMinMax && (!g.hidden || this.includeHidden)) {
                    ...
                    if (this.minMaxField)h = g[this.minMaxField], h < c && (c =
                        h); else for (var k in g)g.hasOwnProperty(k) && "percents" != k && "total" != k && (h = g[k], h < c && (c = h))
                }
            }
        }
        return c
        ...
        for (b = this.start; b <= this.end; b++) {
            ...
            for (d in c)if (c.hasOwnProperty(d)) {
                ...
                if (e.includeInMinMax && (!e.hidden || this.includeHidden)) {
                    ...
                    var f;
                    if (this.minMaxField)f = e[this.minMaxField], f > a && (a = f); else for (var g in e)e.hasOwnProperty(g) &&
        ...
        if ("H" == Fa) {
            if (0 <= b && b <= V + 1 && (0 < s && 0 < v && b + k <= V + 1 && (Y = AmCharts.line(r, [b + k, b + k], [0, s], t, v, A), u.push(Y)), 0 < w && (W = AmCharts.line(r, [b, b + da, b + da], [L, L + X, X], C, w, A, y), u.push(W))), D = 0, G = b, g && 90 == B && (G -= n), !1 === d ? (W = "start", D = "bottom" == ea ? S ? D + s : D - s : S ? D - s : D + s, G += 3, e && (G += e / 2, W = "middle"), 0 < B && (W = "middle")) : W = "middle", 1 == Z && 0 < J && !g && !l && $ <
                V && (d = AmCharts.fitToBounds(b, 0, V), $ = AmCharts.fitToBounds($, 0, V), ha = d - $, 0 < ha && (fill = AmCharts.rect(r, ha, a.height, z, J), fill.translate(d - ha + da, X), u.push(fill))), "bottom" == ea ? (D += L + n / 2 + oa, S ? 0 < B ? (D = L - P / 2 * Math.sin(aa) - s - 3, G += P / 2 * Math.cos(aa)) : 0 > B ? (D -= s + n + 3 + 3 - P / 2 * Math.sin(aa), G -= P / 2 * Math.cos(aa)) : D -= s + n + 3 + 3 : 0 < B ? (D = L + P / 2 * Math.sin(aa) + s + 3, G -= P / 2 * Math.cos(aa)) : 0 > B ? (D = L + s + 3 - P / 2 * Math.sin(aa) + 2, G += P / 2 * Math.cos(aa)) : D += s + q + 3 + 3) : (D += X + n / 2 - oa, G += da, S ? 0 < B ? (D = P / 2 * Math.sin(aa) + s + 3, G -= P / 2 * Math.cos(aa)) : D += s + 3 : 0 < B ? (D =
                    -(P / 2) * Math.sin(aa) - s - 6, G += P / 2 * Math.cos(aa)) : D -= s + n + 3 + q + 3), "bottom" == ea ? ha = (S ? L - s - 1 : L + q - 1) + oa : (ia = da, ha = (S ? X : X - s - q + 1) - oa), f && (G += f), X = G, 0 < B && (X += P / 2 * Math.cos(aa)), x && (ea = 0, S && (ea = P / 2 * Math.cos(aa)), X + ea > V + 2 || 0 > X))x.remove(), x = null
        } else {
...
AmCharts.AmGraph = AmCharts.Class({
    construct: function (a) {
        ...
        if (!da && ("line" == g || "smoothedLine" == g || "step" ==
            ...
            var xa = f.getCoordinate(Ga), ub = f.getCoordinate(f.max);
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g) {
            if (0 < Z) {
                ...
                if (this.fillColorsField)for (H =
                                                  Z; -1 < H; H--)if (P = d[H], x = P.axes[f.id].graphs[b], x.fillColors) {
        ...
        for (H = Z; H <= S; H++) {
            ...
            x.index = H;
            var M, N, K, ba, ja = NaN, F = NaN, E = NaN, Q = NaN, O = NaN, Oa = NaN, Ba = NaN, Pa = NaN, Ca = NaN, ca = NaN, ga = NaN, pa = NaN, qa = NaN, R = NaN, fb = NaN, gb = NaN, la = NaN, na = void 0, za = Kb, Qa = La, ra = oa, ma, sa, Ra = this.pattern;
            ...
            if (ta) {
                ...
                if ("candlestick" == g || "ohlc" == g)R = ta.close, gb = ta.low, Ba = f.getCoordinate(gb), fb = ta.high, Ca = f.getCoordinate(fb);
                la = ta.open;
                E = f.getCoordinate(R);
                ...
                var ja = P.x[X.id], Ha = this.periodSpan - 1, ka = Math.floor(D / 2) + Math.floor(Ha * D / 2), ua = ka, wb = 0;
                "left" == this.stepDirection && (wb = (2 * D + Ha * D) / 2, ja -= wb);
                "start" == this.pointPosition &&
                (ja -= D / 2 + Math.floor(Ha * D / 2), ka = 0, ua = Math.floor(D) + Math.floor(Ha * D));
                ...
                switch (g) {
                    ...
                    case "smoothedLine":
                        ...
                        break;
                    case "step":
                        if (!isNaN(R))x.isNegative = R < ea ? !0 : !1, void 0 == x.lineColor && void 0 == x.fillColors && isNaN(x.dashLength) || (this.drawLineGraph(q, t, T, U), q = [], t = [], T = [], U = [], this.lineColorSwitched = x.lineColor, this.fillColorsSwitched =
                    ...
                    case "column":
                        ...
                        if (!isNaN(R)) {
                            ...
                            if (!(R < xb && la < xb || R > yb && la > yb))if (n) {
                                ...
                                if (N < l && 0 < K && (na = new AmCharts.Cuboid(e, ba, K, z - a.d3x, J - a.d3y, za, Qa, L, ma, V, ha, r, n, Y, Ra), "bottom" != B && "inside" != B && "middle" != B))if (B = f.reversed ? "left" : "right", 0 > R)B = f.reversed ? "right" : "left"; else if ("regular" == I || "100%" == I)ca += this.dx
                            } else {
                                ...
                                if (M < k + $ * z && 0 < K)if (na = new AmCharts.Cuboid(e, K, ba, z - a.d3x, J - a.d3y, za, Qa, L, ma, this.lineAlpha, ha, r, n, Y, Ra), 0 > R && "middle" != B && "inside" != B)B = "bottom"; else if (B = aa, "regular" == I || "100%" == I)ga += this.dy
                            }
                            if (na && (sa = na.set, sa.translate(M, N), this.columnsSet.push(sa), (x.url || this.showHandOnHover) && sa.setAttr("cursor", "pointer"), !da)) {
                                ...
                                "3d" == I && (n ? (y = (C - c) * (this.end + 1 - H), ca += z * this.columnIndex, pa += z * this.columnIndex,
                                    x.y += z * this.columnIndex) : (y = (C - c) * (H + 1), ca += 3, ga += J * this.columnIndex + 7, qa += J * this.columnIndex, x.y += J * this.columnIndex));
                    ...
                    case "candlestick":
                        if (!isNaN(la) && !isNaN(R)) {
                            ...
                            if (n) {
                                if (N =
                                        E - h / 2, M = Q, K = h, N + K > l && (K = l - N), 0 > N && (K += N, N = 0), N < l && 0 < K) {
                                    var jb, kb;
                                    R > la ? (jb = [F, Pa], kb = [Q, Oa]) : (jb = [Q, Pa], kb = [F, Oa]);
                                    !isNaN(Pa) && !isNaN(Oa) && E < l && 0 < E && ($a = AmCharts.line(e, jb, [E, E], ma, V, L), ib = AmCharts.line(e, kb, [E, E], ma, V, L));
                                    ba = F - Q;
                                ...
                                var na = new AmCharts.Cuboid(e, K, ba, z, J, za, Qa, L, ma, V, ha, r, n, Y, Ra), lb, mb;
                                R > la ? (lb = [E, Ca], mb = [O, Ba]) : (lb = [O, Ca], mb = [E, Ba]);
                                !isNaN(Ca) && !isNaN(Ba) &&
                                F < k && 0 < F && ($a = AmCharts.line(e, [F, F], lb, ma, V, L), ib = AmCharts.line(e, [F, F], mb, ma, V, L))
                            }
                    ...
                    case "ohlc":
                        if (!(isNaN(la) || isNaN(fb) || isNaN(gb) || isNaN(R))) {
                            ...
                            var nb, ob, pb;
                            if (n) {
                                var qb = E - h / 2, qb = AmCharts.fitToBounds(qb, 0, l), zb =
                                    AmCharts.fitToBounds(E, 0, l), rb = E + h / 2, rb = AmCharts.fitToBounds(rb, 0, l);
                ...
                if (!da && !isNaN(R)) {
                    ...
                    if (this.end - this.start <= Bb || 0 === Bb) {
                        ...
                        if (Cb) {
                            var fa = this.createLabel(x, 0, 0, Cb), va = 0, wa = 0, Db = fa.getBBox(), Ia = Db.width, Ea = Db.height;
                            switch (B) {
                                case "left":
                                    va = -(Ia / 2 + Da / 2 + 3);
                                    break;
                                ...
                                case "right":
                                    ...
                                    break;
                                case "bottom":
                                    n && "column" == g ? (ca = Fa, 0 > R || 0 < R && f.reversed ? (va = -6, fa.attr({"text-anchor": "end"})) : (va = 6, fa.attr({"text-anchor": "start"}))) :
                            ...
                            if (fa) {
                                if (isNaN(ga) || isNaN(ca))fa.remove(), fa = null; else if (ca += va, ga += wa, fa.translate(ca, ga), n) {
                                    if (0 > ga || ga > l)fa.remove(), fa = null
                                } else {
                                    var Eb =
                                        0;
                                    "3d" == I && (Eb = z * $);
                                    if (0 > ca || ca > k + Eb)fa.remove(), fa = null
                                }
        ...
        if ("line" ==
            g || "step" == g || "smoothedLine" == g)"smoothedLine" == g ? this.drawSmoothedGraph(q, t, T, U) : this.drawLineGraph(q, t, T, U), da || this.launchAnimation();
        ...
        if (1 < a.length) {
            ...
            if (0 < f || 0 < v)if (m = a.join(";").split(";"), p = b.join(";").split(";"), "serial" == e.chart.type && (0 < c.length ? (c.reverse(), d.reverse(), m = a.concat(c), p = b.concat(d)) : e.rotate ? (p.push(p[p.length - 1]), m.push(s), p.push(p[0]), m.push(s), p.push(p[0]), m.push(m[0])) : (m.push(m[m.length - 1]), p.push(s), m.push(m[0]), p.push(s), m.push(a[0]), p.push(p[0]))), a = e.gradientRotation, 0 < f && (b = AmCharts.polygon(g, m, p, r, f, 1, "#000", 0, a), b.pattern(e.pattern), h.push(b)), t || void 0 !==
                u)isNaN(v) && (v = f), t || (t = u), g = AmCharts.polygon(g, m, p, t, v, 1, "#000", 0, a), g.pattern(e.pattern), k.push(g), k.click(function (a) {
                e.handleGraphClick(a)
            });
            e.applyMask(k, h)
        }
    ...
    addListeners: function (a, b) {
        ...
        if (a) {
            var c = this.chart, d = {
                type: "rollOverGraphItem", item: a, index: a.index,
        ...
        if (a) {
            var b;
            for (b =
                     0; b < a.length; b++)clearTimeout(a[b])
        }
        this.timeOuts = []
    }
});
AmCharts.ChartCursor = AmCharts.Class({
            ...
            if (p) {
                ...
                if (c.mouseIsOver || y || z || this.forceShow)if (this.forceShow = !1, z) {
                    ...
                    0 !== d && (g = {
                        type: "zoomed",
                        target: this
                    }, g.chart = this.chart, f.parseDates && !f.equalSpacing ? (c + d > w && (d = w - c), y + d < s && (d = s - y), g.start = y + d, g.end =
                    ...
                    if (u) {
                        if (0 > r)if (y)r = 0; else {
                            this.hideCursor();
                            return
                        }
                        if (r > n + 1)if (y)r = n + 1; else {
                            this.hideCursor();
                            return
                        }
                    } else {
                    ...
                    if (a != this.previousIndex || B != this.previousMostCloseGraph)if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], J && this.valueBalloonsEnabled && t && c.balloon.enabled) {
                        ...
                        for (w = 0; w < J.length; w++)if (f = J[w], (!this.oneBalloonOnly || f ==
                            B) && f.showBalloon && !f.hidden && f.balloonText && ("step" == f.type && "left" == f.stepDirection && (p = this.data[a + 1]), p)) {
                            ...
                            if (!isNaN(s)) {
                                ...
                                t && (1 != this.graphBulletSize && AmCharts.isModern && (t = v.bulletGraphics) && (t.getBBox(), t.translate(v.bx,
                    ...
                    b ?
                        (g = {type: "changed"}, g.index = a, g.chart = this.chart, g.zooming = y, g.mostCloseGraph = B, g.position = u ? e : d, g.target = this, c.fire("changed", g), this.fire("changed", g), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, c.updateLegendValues(a));
    ...
    handleMouseOut: function () {
        ...
        if (a) {
            ...
            if (this.enabled && 0 < b.length) {
                if (this.pan)this.rolledOver = !1; else if (this.zoomable && this.zooming) {
                    ...
                    c.target = this;
                    c.chart = a;
                    if ("cursor" == this.type)this.rotate ? this.selectionPosY = e : this.selectionPosX = e = d, 2 > Math.abs(e - this.initialMouse) && this.fromIndex == this.index || (this.index < this.fromIndex ? (c.end = this.fromIndex, c.start = this.index) :
                        (c.end = this.index, c.start = this.fromIndex), e = a.categoryAxis, e.parseDates && !e.equalSpacing && (c.start = b[c.start].time, c.end = a.getEndTime(b[c.end].time)), this.skipZoomDispatch || this.fire(c.type, c)); else {
                        var g = this.initialMouseX, h = this.initialMouseY;
                        3 > Math.abs(d - g) && 3 > Math.abs(e - h) || (b = Math.min(g, d), f = Math.min(h, e), d = Math.abs(g - d), e = Math.abs(h - e), a.hideXScrollbar && (b = 0, d = this.width), a.hideYScrollbar && (f = 0, e = this.height), c.selectionHeight = e, c.selectionWidth = d, c.selectionY = f, c.selectionX = b, this.skipZoomDispatch ||
                        this.fire(c.type, c))
                    }
                    this.selectWithoutZooming || AmCharts.remove(this.selection)
                }
        ...
        if (this.zoomable || this.pan || this.drawing) {
            ...
            if (0 < d && d < this.width && 0 < e && e < this.height ||
                ...
                d, this.selectionPosX = this.linePos)) : (this.initialMouseX = d, this.initialMouseY = e, this.selectionPosX = d, this.selectionPosY = e), this.zooming = !0)
        }
    }
});
...
AmCharts.wedge = function (a, b, c, d, e, f, g, h, k, l, m, n) {
    ...
    359.94 < q && (q = 359.94);
    e >= q && (e = q);
    var t = 1 / 180 * Math.PI, q = b + Math.sin(d * t) * h, v = c - Math.cos(d * t) * r, s = b + Math.sin(d * t) * f, w = c - Math.cos(d * t) * g, A = b + Math.sin((d + e) * t) * f, C = c - Math.cos((d + e) * t) * g, y = b + Math.sin((d + e) * t) * h, t = c - Math.cos((d + e) * t) * r, z = {
...
AmCharts.AmDraw = AmCharts.Class({
    construct: function (a, b, c, d) {
        ...
        } else AmCharts.isIE && AmCharts.VMLRenderer && (AmCharts.VML = !0, AmCharts.vmlStyleSheet || (document.namespaces.add("amvml", "urn:schemas-microsoft-com:vml"), e = document.createStyleSheet(),
...
AmCharts.AmLegend = AmCharts.Class({
    construct: function (a) {
        ...
        if (!1 !== a.visibleInLegend) {
            ...
            if (this.useGraphSettings)if (m = a.type, this.switchType = void 0, "line" == m || "step" == m || "smoothedLine" == m || "ohlc" == m)g = k.set(), a.hidden || (d = a.lineColorR, f = a.bulletBorderColorR), n = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength), g.push(n), a.bullet && (a.hidden || (d = a.bulletColorR), n = AmCharts.bullet(k,
                a.bullet, a.bulletSize, d, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (n.translate(l + 1, l / 2), g.push(n)), p = 0, m = l, n = l / 3; else {
                var r;
            ...
            (f = this.switchType) && "none" != f && ("x" == f ? (r = this.createX(), r.translate(l / 2, l / 2)) : r = this.createV(), r.dItem = a, !0 !== a.hidden ? "x" == f ? r.hide() : r.show() : "x" != f && r.hide(), this.switchable || r.hide(), this.addListeners(r, a), a.legendSwitch = r, k.push(r));
            f = this.color;
